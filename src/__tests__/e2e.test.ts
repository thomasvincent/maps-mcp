      ...
      inputSchema: {
        ...
        properties: {
          query: {
            type: "string",
            description:
              "Search query (e.g., 'coffee shops near me', 'Eiffel Tower')",
          },
        },
        required: ["query"],
      },
      ...
      inputSchema: {
        ...
        properties: {
          from: {
            type: "string",
            description:
              "Starting location (address or place name, or 'current location')",
          },
          to: {
            type: "string",
      ...
      inputSchema: {
        ...
        properties: {
          ...
          near: {
            type: "string",
            description:
              "Location to search near (optional, defaults to current location)",
          },
        },
        required: ["type"],
      },
    ...
    switch (name) {
      ...
      case "maps_get_directions": {
        const {
          ...
          to,
          mode = "driving",
        } = args as { from?: string; to: string; mode?: string };
...
describe("Maps MCP Server E2E Tests", () => {
  ...
  describe("Tool Handlers - maps_open", () => {
    it("should open Apple Maps app", () => {
      ...
      expect(response.content).toEqual([
        { type: "text", text: "Apple Maps opened" },
      ]);
  ...
  describe("Tool Handlers - maps_search", () => {
    it("should search for a location", () => {
      ...
      expect(response.content).toEqual([
        { type: "text", text: "Searching for: coffee shops" },
      ]);
      expect(mockedExecSync).toHaveBeenCalledWith(
  ...
  describe("Tool Handlers - maps_get_directions", () => {
    ...
    it("should get directions with from and to locations", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("saddr=Central%20Park")
      );
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("daddr=Times%20Square")
      );
    });
    ...
    it("should handle 'current location' as from address", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.not.stringContaining("saddr")
      );
    });
    ...
    it("should use walking mode", () => {
      ...
      expect(response.content[0]).toHaveProperty(
        "text",
        "Getting walking directions to Library"
      );
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("dirflg=w")
      );
    });
    ...
    it("should use transit mode", () => {
      ...
      expect(response.content[0]).toHaveProperty(
        "text",
        "Getting transit directions to Downtown"
      );
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("dirflg=r")
      );
    });
    ...
    it("should default to driving mode when not specified", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("dirflg=d")
      );
    });
  ...
  describe("Tool Handlers - maps_show_location", () => {
    ...
    it("should handle international addresses", () => {
      ...
      expect(response.content[0].text).toBe(
        "Showing: 10 Downing Street, London, UK"
      );
    });
  });
  ...
  describe("Tool Handlers - maps_show_coordinates", () => {
    it("should show coordinates without label", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("ll=37.7749,-122.4194")
      );
    });
    ...
    it("should handle zero coordinates", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("ll=0,0")
      );
    });
  ...
  describe("Tool Handlers - maps_drop_pin", () => {
    it("should drop pin at address without label", () => {
      ...
      expect(response.content).toEqual([
        { type: "text", text: "Dropped pin at: 123 Main Street" },
      ]);
    });
    ...
    it("should drop pin at address with label", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("q=My%20Home")
      );
    });
  ...
  describe("Tool Handlers - maps_create_url", () => {
    it("should create shareable URLs", () => {
      ...
      expect(text).toContain(
        "https://maps.apple.com/?address=Eiffel%20Tower%2C%20Paris"
      );
    });
  ...
  describe("Input Validation", () => {
    ...
    it("should handle special characters in address", () => {
      ...
      expect(response.content[0]).toHaveProperty(
        "text",
        "Showing: 123 O'Brien Street & Main Ave"
      );
    });
    ...
    it("should handle negative coordinates", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("ll=-33.8688,151.2093")
      );
    });
    ...
    it("should handle addresses with numbers", () => {
      ...
      expect(response.content[0].text).toBe(
        "Showing: 12345 67890 Street, Unit #100"
      );
    });
  });
  ...
  describe("URL Encoding", () => {
    ...
    it("should properly encode plus signs", () => {
      ...
      expect(mockedExecSync).toHaveBeenCalledWith(
        expect.stringContaining("coffee%2Btea")
      );
    });
  });
